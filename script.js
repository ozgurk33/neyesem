...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuItems = [
    /* --- Dürümler (13) --- */
    { c: 'durum', n: 'Tavuk Döner Dürüm',              d: D.klasik,       p: 180, img: img.durumDoner },
    { c: 'durum', n: 'Soslu Tavuk Döner Dürüm',        d: D.sosluDurum,   p: 200, img: img.durumSoslu },
    { c: 'durum', n: 'Soslu-Kaşarlı Tavuk Döner Dürüm',d: D.kasarliDurum, p: 220, img: img.durumKasarli },
    { c: 'durum', n: 'Arnavut Ciğeri (Dana) Dürüm',    d: D.ciger,        p: 300, img: img.durumCiger },
    ...
    { c: 'durum', n: 'Köfte Dürüm',                    d: D.klasik,       p: 300, img: img.durumKofte },
    { c: 'durum', n: 'Ne Yesem Dürüm (Tavuk)',         d: 'Patates, ayran', p: 300, img: img.durumNeYesem },
    { c: 'durum', n: 'Ne Yesem Dürüm (Tavuk)',         d: 'Patates, kola',  p: 350, img: img.durumNeYesem },
    { c: 'durum', n: 'Ne Yesem Dürüm (Et)',            d: 'Patates, ayran', p: 450 },
    { c: 'durum', n: 'Ne Yesem Dürüm (Et)',            d: 'Patates, kola',  p: 500 },

    /* --- Ekmek Araları (5) --- */
    { c: 'ekmek', n: 'Ekmek Arası Tavuk Döner',           d: D.klasik,    p: 180, img: img.ekmekDoner },
    { c: 'ekmek', n: 'Arnavut Ciğeri (Dana) Ekmek Arası', d: D.ciger,     p: 300 },
    { c: 'ekmek', n: 'Ekmek Arası Köfte',                 d: D.klasik,    p: 300, img: img.ekmekKofte },
    { c: 'ekmek', n: 'Ekmek Arası Tavuk Külbastı',        d: D.kulbasti,  p: 250 },
    { c: 'ekmek', n: 'Ekmek Arası Sucuk',                 d: 'Ne Yesem dana sucuk', p: 250 },

    /* --- Servisler (9) --- */
    { c: 'servisler', n: 'Tavuk Döner Servis',      d: D.servisSade, p: 250, img: img.servisDoner },
    { c: 'servisler', n: 'Arnavut Ciğeri (Dana)',   d: D.ciger,      p: 350, img: img.servisCiger },
    { c: 'servisler', n: 'Adana Servis',            d: D.servisKoz,  p: 400, img: img.servisAdana },
    { c: 'servisler', n: 'Urfa Servis',             d: D.servisKoz,  p: 400, img: img.servisUrfa },
    ...
    { c: 'servisler', n: 'Köfte Servis',            d: D.servisSade, p: 350, img: img.servisKofte },
    ...
    /* --- Tostlar (12) --- */
    { c: 'tost', n: 'Beyaz Peynirli Tost (Ekmek)',    d: '', p: 200 },
    { c: 'tost', n: 'Beyaz Peynirli Tost (Bazlama)',  d: '', p: 220 },
    { c: 'tost', n: 'B. Peynirli Domatesli Tost (Ekmek)',   d: '', p: 200 },
    { c: 'tost', n: 'Peynirli Domatesli Tost (Bazlama)',    d: '', p: 220 },
    { c: 'tost', n: 'Kaşarlı Tost (Ekmek)',           d: '', p: 200 },
    { c: 'tost', n: 'Kaşarlı Tost (Bazlama)',         d: '', p: 220 },
    { c: 'tost', n: 'Kaşarlı Sucuklu Tost (Ekmek)',   d: '', p: 270 },
    { c: 'tost', n: 'Kaşarlı Sucuklu Tost (Bazlama)', d: '', p: 300 },
    { c: 'tost', n: 'Kavurmalı Kaşarlı Tost (Ekmek)',   d: '', p: 450 },
    { c: 'tost', n: 'Kavurmalı Kaşarlı Tost (Bazlama)', d: '', p: 470 },
    { c: 'tost', n: 'Karışık Tost (Ekmek)',   d: 'Salam, sucuk, kaşar', p: 300 },
    { c: 'tost', n: 'Karışık Tost (Bazlama)', d: 'Salam, sucuk, kaşar', p: 320 },

    /* --- Gözlemeler (4) --- */
    { c: 'gozleme', n: 'Peynirli Gözleme',           d: D.gozleme, p: 200 },
    { c: 'gozleme', n: 'Kaşarlı Gözleme',            d: D.gozleme, p: 200 },
    { c: 'gozleme', n: 'Patatesli Gözleme',          d: D.gozleme, p: 200 },
    { c: 'gozleme', n: 'Patatesli Kaşarlı Gözleme',  d: D.gozleme, p: 220 },
    ...
    { c: 'icecek', n: 'Karışık İçecekler', d: '', p: 70, img: img.karisikIce },
    ...
    { c: 'icecek', n: '1 Litre Ayran',   d: '', p: 90,  img: img.ayran1lt },
    { c: 'icecek', n: '1 Litre Kola',    d: '', p: 90,  img: img.cola1lt },
    { c: 'icecek', n: '1 Litre Şalgam',  d: '', p: 90,  img: img.salgam },
